...
<%
	...
	if(Generic.checkLogin(request, response)){
		...
		last_name 			 = customer.getCust_landline();
...
<html>
	<head>
		...
		<title>Royal Bank | Profile View</title>
								...
								<form>
									<div class="row">
										<div class="col-md-3 padding-top-5">
										    ...
										    <input readonly="readonly" type="text" class="form-control" id="title" name="title" placeholder="First Name" value="<%= title %>" />
										</div>
										<div class="col-md-3 padding-top-5">
										    <label for="city" class="control-label">Name:</label>
										    <input readonly="readonly" type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="<%= first_name %>" />
										</div>
										<div class="col-md-3 padding-top-5">
										    <label for="city" class="control-label">Last Name:</label>
										    <input readonly="readonly" type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="<%= last_name %>" />
										</div>
											<div class="col-md-3 padding-top-5">
											<label for="city" class="control-label">Identity Number:</label>
											<input readonly="readonly" type="text" class="form-control" id="id_num" name="id_num" placeholder="ID Number" readonly value="<%= id_number %>" />
										</div>
									</div>
									<div class="row">
										<div class="col-md-4 padding-top-10">
											<label for="email" class="control-label">Email Adress:</label>
										    <input readonly="readonly" type="text" class="form-control" id="email" name="email" placeholder="Email" readonly value="<%= email %>" />
										</div>
										<div class="col-md-4 padding-top-10">
										    <label for="city" class="control-label">LandLine:</label>
										    <input readonly="readonly" type="text" class="form-control" id="landline" name="landline" placeholder="Landline" value="<%= landline %>" />
										</div>
										<div class="col-md-4 padding-top-10">
										    <label for="city" class="control-label">Mobile:</label>
										    <input readonly="readonly" type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile" value="<%= mobile %>" />
										</div>
									</div>
									<div class="row">
										<div class="col-md-12 padding-top-10">
											<label for="address1" class="control-label">Residential Address:</label>
											<input readonly="readonly" type="text" class="form-control" name="residential_address" placeholder="Residential Address" value="<%= residential_address %>" />
										</div>
									</div> 
									<div class="row">
										<div class="col-md-4 padding-top-10">
											<label for="title" class="control-label">Province:</label>
											<input readonly="readonly" type="text" class="form-control" id="residential_province" name="residential_province" placeholder="Residential province" value="<%= residential_province %>" />
										</div>
										<div class="col-md-3 padding-top-10">
											<label for="city" class="control-label">Postal Code:</label>
											<input readonly="readonly" type="text" class="form-control" id="residential_post" name="residential_post" placeholder="Post Code" value="<%= residential_post %>" />
										</div>
									</div>
									<div class="row">
										<div class="col-md-12 padding-top-10">
											<label for="address1" class="control-label">Postal Address:</label>
											<input readonly="readonly" type="text" class="form-control" name="postal_address" placeholder="Residential Address" value="<%= postal_address %>" />
										</div>
									</div> 
									<div class="row">
										<div class="col-md-4 padding-top-10">
											<label for="title" class="control-label">Province:</label>
											<input readonly="readonly" type="text" class="form-control" id="postal_province" name="postal_province" placeholder="Postal province" value="<%= postal_province %>" />
										</div>
										<div class="col-md-3 padding-top-10">
											<label for="city" class="control-label">Postal Code:</label>
											<input readonly="readonly" type="text" class="form-control" id="postal_post" name="postal_post" placeholder="Post Code" value="<%= postal_post %>" />
										</div>
									</div>
									<div class="row">
										<div class="col-md-2">
										<br /><br /> 
											<a href="update.jsp?key=<%= Generic.getSecurityKey(request, response) %>"><button type="button" id="submit_reg" name="submit_reg" class="btn btn-success">Update Profile</button></a>
										</div>
									</div>
								</form>
							</div>
